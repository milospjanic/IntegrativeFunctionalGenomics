...
Another example of the better separation of p-values is the example of dataset of open chromatin regions in ENCODE CD4 T- cells. When tested with the standard binomial test the immune-related categories do not emerge to the top of the list, while the top categories are not immune- related and are again relatively small or unrelated datasets (CardiogramplusC4D, Coronary Heart disease). When modified binomial is applied, we obtained better resolution of GWAS categories, with the immune- category, Rheumatoid arthritis, being the top category.

**Example of standard binomial test - GM12878 ENCODE cell line** GWAS categories did not resolve well according to the p-values.

![ScreenShot](https://github.com/milospjanic/IntegrativeFunctionalGenomics/blob/master/GM12878.ENCODE.binomial.png)

**Example of modified binomial test - GM12878 ENCODE cell line** We can see better resolution of GWAS categories by thier p-values. Note that modified binomial gives immune- related categories (Rheumatoid arthritis, Crohns disease) as top ones, as expected for a cell line with the blood origin, such as GM12878 ENCODE cell line.

![ScreenShot](https://github.com/milospjanic/IntegrativeFunctionalGenomics/blob/master/GM12878.ENCODE.binomial.mod.png)
